 ...
 * @param {string} cfg.hasCommentsForRole - return only issues that are visible only to this group
 * @param {string} cfg.hasCommentsWithVisibility - return only issues that have this visibility
