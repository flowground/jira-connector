...
function processTrigger(msg, cfg, snp) {
    ...
    // first trigger run, use start date; subsequent runs, use last processed id and start date
    let jql = snp.lastProcessedIssueId ? 'id>$id and updated>=$startDateTime' : 'updated>=$startDateTime';
