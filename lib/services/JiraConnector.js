...
class JiraConnector {
     ...
     * @param {boolean} [insideString=false] - true if escape value is to be used inside another string
     * @returns {string}
     */
     ...
     * @param {object} [params] params - url search parameters
     * @param {object} [data] data - data to be sent as json in the request body
     * @returns {Promise}
     */
